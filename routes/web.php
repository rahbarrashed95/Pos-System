...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get("pos/search_imei",[SellPosController::class, 'search_imei']);
    ...
    Route::get('checking-warrnty', [WarrantyController::class, 'checking_warrnty'])->name('checking_warrnty');
