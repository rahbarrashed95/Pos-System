...
@foreach($page_products as $page_product)
	...
	@endif
		<td align="center" valign="center">
			<div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}in; justify-content: center;">
				...
				<div>
					...
					@if(!empty($print['business_name']))
						<b style="display: block !important; font-size: 15px">{{$business_name}}</b>
					@endif
					...
					@if(!empty($print['variations']) && $page_product->is_dummy != 1)
						<span style="font-size: {{$print['variations_size']}}px">
					...
					@endif
					{{-- Barcode --}}
					<img style="width:95% !important;height: {{$barcode_details->height*0.24}}in !important; display: block;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($page_product->sub_sku, $page_product->barcode_type, 1,30, array(0, 0, 0), false)}}">
